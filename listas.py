...
# Abaixo estamos falando: Pega a lista6, coloca espaço entre cada elemento e tranforme em uma string
curso = ' '.join(lista6)
print(curso)

# Abaixo estamos falando: Pega a lista6, coloca cifrão entre cada elemento e tranforme em uma string
curso = '$'.join(lista6)
print(curso)
...
# Para entender melhor o índice negativo, pense na lista como um círculo, onde o final de um elemento
# está ligado ao início da lista
...
lista = [1, 2, 3, 4]
print(lista[1:])  # Iniciando no índice 1 e pegandos todos os elementos restantes
...
# independentes, ou seja, modificando uma lista, não afeta a outra. Isso em Python é chamado de Deep Copy (cópia pro-
# funda).
...
# Veja que utilizamos a cópia via atribuição e copiamos os dados da lista para a nova lista, mas após realizar modi-
# ficação em uma das listas, essa modificação se refletiu em ambas as listas. Isso em Python é chamado de Shallow
# Copy.
"""
