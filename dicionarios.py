...
print(usuario)
print(type(usuario))
# OBS: O método fromkeys receber dois parâmetros: um iterável e um valor.
# Ele vai gerar para cada f=valor do iterável uma chave e irá atribuir a esta chave o valor informado.
