...
print(s)
print(type(s))
# OBS: Ao adicionar um conjunto, caso seja adicionado um valor já existente, o mesmo será ignorado sem gerar error
...
# Assim como todos os outros conjuntos em Python, podemos colocar tipos de dados misturados em Sets.
s = {1, 'b', True, 34.22, 44}
print(s)
print(type(s))
...
cidade = set(cidades)
print(cidade)
print(f' Temos {len(cidade)} cidades diferentes')
...
# Imagine que temos dois conjuntos: Um contendo estudantes do curso de Python e um contendo estudantes do curso de
# Java.
