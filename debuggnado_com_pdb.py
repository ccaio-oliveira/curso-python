...
# O debug é utilizado durante o desenvolvimento. Custamos realizar todos os imports de bibliotecas no início do
# arquivo. Por isso, ao invés de colocarmos o import do pdb no início do arquivo, nós colocamos somente onde
# vamos debuggar, e ao finalizar já fazemos a remoção.


# Exemplo 3

# * A partir do Python 3.7, não é mais necessário importar a biblioteca pdb, pois o comando de debug foi incorporada
