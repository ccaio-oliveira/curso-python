...
OBS: Tratar erro de forma genérica não pe a melhor forma de tratamento de erros. O ideal é SEMPRE tratar de forma
específica.
...
# Exemplo 5 - Trabalhando um erro específico com detalhes do erro
try:
    len(5)
