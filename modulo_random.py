...
# Ao realizar o import de todo o módulo, todas a funções, atributos, classes e propriedades que estiverem
# dentro do módulo ficarão disponíveis (Ficarão em memória). Caso você saiba quais funções você precisa utilizar
# deste módulo, esntão esta não seria a forma ideal de utilização. Nós veremos uma forma melhor na Forma 2.
