...
# OBS: Se o usuário passar somente 1 argumento, este será atribuído ao parâmetro numero, e será calculado o quadrado
# deste número;
...
# Podemos ter funções que são declaradas dentro de funções, e também tem uma forma de escopo de variável
