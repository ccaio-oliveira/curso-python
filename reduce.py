...
# E você tem uma função que receber dois parâmetros:

def funcao(x, y):
    return x * y


Assim como map() e filter(), a função reduce() receber dois parâmetros: a função e o iterável.
